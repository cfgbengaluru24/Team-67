    ...
    return (
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow-md p-6" style={{width:"930px"}}>
            <h3 className="text-xl font-bold mb-4">User Details</h3>
            <div className="box" style={{border:"1px solid lightgrey" ,padding:"10px",borderRadius:"10px",boxShadow:"1px 1px 5px lightgrey",display:"flex",justifyContent:"space-evenly", marginBottom:"20px"}}>
                <h4 style={{fontWeight:"bold", marginBottom:"10px", marginRight:"15px"}}>Upcoming Classes :</h4>
            ...
            <div className="box" style={{border:"1px solid lightgrey" ,padding:"10px",borderRadius:"10px",boxShadow:"1px 1px 5px lightgrey",display:"flex",justifyContent:"space-evenly"}}>
                <h4 style={{fontWeight:"bold", marginBottom:"10px", marginRight:"15px"}}>Upcoming Classes :</h4>
                <ul style={{display:"flex"}}>
