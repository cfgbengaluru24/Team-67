...
const AllotVol = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="bg-white rounded-lg shadow-md p-6 w-full" style={{width:"90vw"}}>
        <h3 className="text-xl font-semibold mb-4">Volunteer Allotment</h3>
        <div className="grid  gap-4" style={{width:"50vw" ,display:"flex"}}>
          {mappings.map((mapping, index) => (
            <div key={index} className="bg-gray-100 p-4 rounded shadow-md" style={{width:"500px"}}>
