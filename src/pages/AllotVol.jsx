...
const initialMappings = [
  { studentName: 'John Doe', volunteerName: 'Jane Smith', approved: false, allotted: false },
  { studentName: 'Alice Johnson', volunteerName: 'Robert Brown', approved: false, allotted: false },
        ...
        <div className="grid grid-cols-1 gap-4">
          {mappings.map((mapping, index) => (
            <div key={index} className="bg-gray-100 p-4 rounded shadow-md">
              ...
              <br />
              <span className="font-semibold">Volunteer:</span> {mapping.volunteerName}
              <div className="mt-2">
                {mapping.allotted ? (
                  <button
